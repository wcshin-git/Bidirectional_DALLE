...
from dalle_pytorch.execute_type import SequentialSequence
from dalle_pytorch.attention import Attention, SparseConvCausalAttention, SparseAxialCausalAttention
...
class Transformer(nn.Module):
    def __init__(
        ...
        *,
        ...
        attn_route_map = {'mask': route_attn, 'task': route_attn}
